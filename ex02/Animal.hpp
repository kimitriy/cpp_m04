...
class Animal
{
	...
	public:
		...
		//setter
		virtual void	setIdea( int indx, std::string idea ) = 0;
		virtual void	setAllIdeas( std::string idea ) = 0;

		//getter
		std::string			getType( void ) const;
		virtual std::string	getIdea( int indx ) const = 0;

		//m-methods
		virtual void	makeSound( void ) = 0;
		virtual void	printIdeas( void ) = 0;
};
